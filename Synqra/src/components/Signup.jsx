    ...
    <>
      <div>
        ...
        >
          ...
          <h2 className="text-center">It's free and always will be</h2>
          ...
          <p className="text-sm">Have an account? <Link to = {"/login"} className="text-blue-600 underline cursor-pointer">
            Login</Link></p>
        </form>
      </div>
      </div>
